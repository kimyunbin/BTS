      ...
      <div class="section">
        <v-container grid-list-xl>
          ...
          <v-layout row justify-center align-center wrap class="mt-4 pt-2">
            <v-img
              aspect-ratio="0.5" height="500" contain
              src="https://i.ibb.co/wNgFZWS/Kakao-Talk-20211006-204201609.png"
            ></v-img>
          </v-layout>

          <v-layout row justify-center align-center wrap class="mt-4 pt-2">
            <h1 data-aos="fade-down"><b>BTS에 오신 여러분을 환영합니다.</b></h1><br>
          </v-layout>
          
          <v-layout row justify-center align-center wrap class="mt-3 pt-2">
            <div class="s1_arrow">
        ...
        <v-container grid-list-xl>
          ...
          <v-layout row justify-center align-center wrap class="mt-4 pt-2">
            <v-img
              ...
              aspect-ratio="0.5" height="600" contain
              src="https://i.ibb.co/vqP8t8T/Kakao-Talk-20211006-204201609-01.png"
            ></v-img>
        ...
        <v-container grid-list-xl>
          ...
          <v-layout row justify-center align-center wrap class="mt-4 pt-2">
            <v-img
              lazy-src="https://picsum.photos/id/11/10/6"
              aspect-ratio="0.5" height="600" contain
              src="https://i.ibb.co/pyvBH41/Kakao-Talk-20211006-204201609-02.png"
            ></v-img>
