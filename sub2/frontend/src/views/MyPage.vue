<template>
  <div>
    ...
    <h1 data-aos="fade-left"><b>내가 직접 만든 여행코스</b></h1>
    <br>
    <section v-if="my_road.status!='fail'" data-aos="fade-right">
    ...
    <section v-else>
      <v-layout row justify-center align-center wrap class="mt-4 pt-2" >
        <p><b>만든 여행경로가 없습니다.</b></p>
      </v-layout>
    </section>
    <br>
    <br>
    <h1 data-aos="fade-right"><b>찜한 여행코스</b></h1>
    <br>
    
      <section v-if="my_wish_road.length>0"  data-aos="fade-left">
        <v-layout row justify-center align-center wrap class="mt-4 pt-2" >
          <v-card @click="setDetailRoad(3)" hover >
          ...
          <v-card @click="setDetailRoad(4)" hover v-if="my_wish_road.length>1">
          ...
          <v-card @click="setDetailRoad(5)" hover v-if="my_wish_road.length>2">
  ...
  methods: {
    ...
    initMap() {
      ...
      if(this.my_road.status!="fail"){
        ...
        if(this.my_road.length>1){
          var map2 = new kakao.maps.Map(container2, options2);
        }
        if(this.my_road.length>2){
