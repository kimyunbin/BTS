...
<div>
  <div id="map-wrapper" class="map-wrapper">
    <div class="satitext">
      <p>해당 지역은</p>&nbsp;
      <p>
        <span class="word wisteria">시민주권</span>
        <span class="word belize">특별자치시</span>
        <span class="word pomegranate">세종</span>
...
const MAP_GEOJSON = require('./sejong.json'); // json 파일 입력시 해당지역 지도 출력
  ...
  methods: {
    ...
    drawMap() {
      ...
      namesLayer
        ...
        .enter()
        .append('text')
        .attr('x', d=> projection([d.lon, d.lat])[0]-60)
        .attr('y', d=> projection([d.lon, d.lat])[1]-80)
        .text(function(d) {
            return d.name;
        })
