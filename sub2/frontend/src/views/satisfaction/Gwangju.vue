...
<div>
  <div id="map-wrapper" class="map-wrapper">
    <div class="text">
      <p>해당 지역은</p>&nbsp;
      <p>
        <span class="word wisteria">정의롭고</span>
        <span class="word belize">풍요로운</span>
        <span class="word pomegranate">광주</span>
...
const MAP_GEOJSON = require('./gwangju.json'); // json 파일 입력시 해당지역 지도 출력
  ...
  methods: {
    store() {
      for(var i=0; i < this.satis_area.length; i++) {
        if(this.satis_area[i]["state"] === "광주광역시") {
