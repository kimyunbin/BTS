...
<div>
  <div id="map-wrapper" class="map-wrapper">
    <div class="satitext">
      <p>해당 지역은</p>&nbsp;
      <p>
        <span class="word wisteria">시민과 함께</span>
        <span class="word belize">다시 뛰는</span>
        <span class="word pomegranate">울산</span>
...
const MAP_GEOJSON = require('./ulsan.json'); // json 파일 입력시 해당지역 지도 출력
  ...
  methods: {
    store() {
      for(var i=0; i < this.satis_area.length; i++) {
        if(this.satis_area[i]["state"] === "울산광역시") {
