...
<div>
  <div id="map-wrapper" class="map-wrapper">
    <div class="text">
      <p>해당 지역은</p>&nbsp;
      <p>
        <span class="word wisteria">내 삶이</span>
        <span class="word belize">좋아지는</span>
        <span class="word pomegranate">대구</span>
...
const MAP_GEOJSON = require('./daegu.json'); // json 파일 입력시 해당지역 지도 출력
  ...
  methods: {
    store() {
      for(var i=0; i < this.satis_area.length; i++) {
        if(this.satis_area[i]["state"] === "대구광역시") {
